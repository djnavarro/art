...
make_carousel <- function() {
  ...
  paste(
    ...
    '      <div class="carousel-item" style="background-image: url(\'img/flametree/ft_298d.png\')"></div>',
    '      <div class="carousel-item" style="background-image: url(\'img/flametree/flametree_20_13.png\')"></div>',
    '      </div>',
    '      ',
...
make_profile <- function() {
  paste(
    ...
    '      Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin rutrum molestie est sed lacinia. Curabitur quis sodales augue. Integer ultrices nunc tortor, non lacinia arcu fermentum faucibus. Cras odio dolor, pellentesque at <span class="text-white">generative artwork created with the R programming language</span> vehicula est. Nulla in finibus est. In hac habitasse platea dictumst. Vivamus nec sem sit amet ante efficitur elementum a vitae sapien. Integer sed ante tincidunt, rutrum enim at, imperdiet turpis. In imperdiet faucibus neque a tincidunt. Sed mollis consequat lorem. Phasellus consectetur, nisl in sagittis vehicula, est nisl eleifend <a href="https://djnavarro.net"><span class="text-white">https://djnavarro.net</span></a> arcu, eget pellentesque nunc sem non mi. Quisque quis scelerisque dolor. Donec scelerisque purus quis ex condimentum blandit. Vivamus non lorem eros. Aliquam ac dui at ante vehicula cursus nec et lectus. Integer et <a href="https://twitter.com/djnavarro"><span class="text-white">https://twitter.com/djnavarro</span></a> mauris posuere, faucibus orci vel, facilisis urna. Vivamus vitae porta lorem, eleifend imperdiet risus. Aliquam sit amet justo id turpis euismod ultrices. Duis id dui velit. Nullam non purus ut tortor blandit faucibus sit amet non lacus. Sed commodo pulvinar ipsum in tristique. Maecenas finibus, enim vel sagittis faucibus, lectus lectus varius neque, eu cursus felis diam in quam.', 
    '    </p>',
    '      </div>',
    '      </div>',
    '      </div>	',
