...
At the moment I don't sell my art or make prints, but don't let that stop you if you would like one! Unless stated otherwise all the artwork on the site is released under a Creative Commons licence (specifically, [CC-BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)), so you are welcome to reuse the art for most purposes so long as you attribute the original work to me, and any derivative works are also covered by the same licence.
