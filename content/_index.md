...
At the moment I don't sell prints, but don't let that stop you if you would like one! Unless stated otherwise, the art on this site is released under a Creative Commons licence (specifically, [CC-BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)). You are welcome to reuse the art for most purposes so long as you attribute the original work to me and derivative works are covered by the same licence.
