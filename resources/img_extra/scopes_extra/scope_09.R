...
# adjuster
adjust_palette <- function(palette, r = 1, g = 1, b = 1, ...) {
  function(n, ...) {
    cols <- palette(n, ...)
...
# paletting function
#color_scheme <- adjust_palette(scico, b = .6)
color_scheme <- jasmines::palette_manual(c(lgbt,trans))

# filename 
fname <- paste0("~/Desktop/scope_09_", seed, ".png")
